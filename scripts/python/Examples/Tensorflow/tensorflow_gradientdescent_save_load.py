...
with tf.Session() as sess:
    if os.path.isfile("./log/20190101_010101/model.ckpt.meta"):
        print("###############################")
        print("Existing model is being loaded.")
        print("###############################")
        saver.restore(sess,"./log/20190101_010101/model.ckpt")
    else:
        print("###############################")
...
# ===============================
    ...
    save_path = saver.save(sess, "./log/20190101_010101/model.ckpt")
    print(save_path)
